...
/**
 * Keeps track of various stats within the game at a global level. This is dynamic information. Static information is
 * provided by the {@link DefenceField} class
 *
 * @see DefenceField
 */
@RegisterSystem
...
public class StatSystem extends BaseComponentSystem {
    ...
    /**
     * Progress the counter to the next wave. It is impossible to go back a wave, hence there is no decrement option.
     */
