...
/**
 * Marks that an entity has one or more child particle entities. Also provides a reference to them.
 *
 * @see InWorldRenderer
 */
public class ChildrenParticleComponent implements Component {
    /**
     * The particles attached to the entity. The key used for this map is the prefab of the entity
     */
