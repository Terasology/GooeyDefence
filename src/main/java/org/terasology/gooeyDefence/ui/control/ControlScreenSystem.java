...
/**
 * Manages the display & closing of the ControlScreen. Also updates the screen where needed with specific values.
 *
 * @see ControlScreen
 */
@RegisterSystem
public class ControlScreenSystem extends BaseComponentSystem {
     ...
     * <p>
     * Called when the Frob button is pressed. Filters on {@link CharacterComponent} Has an {@link
