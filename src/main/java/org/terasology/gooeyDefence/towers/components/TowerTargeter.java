 ...
 * <p>
 * Targeters select the enemies the tower will attack. They require power, provided by {@link TowerCore}s
 * <p>
...
public abstract class TowerTargeter implements Component {
    ...
    public int drain;
    /**
     * The range of this targeter given in blocks
     */
    public int range;
    /**
     * The time between attacks for this targeter given in ms
     */
    ...
    /**
     * A balancing multiplier passed to effectors on this tower. It's used to provide balancing between different tower
     * types.
     *
