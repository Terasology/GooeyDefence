...
/**
 * Applies a brief stun to an enemy. This stun stops the enemy from moving for the duration of the stun.
 * <p>
...
public class StunEffectorComponent extends TowerEffector {
    /**
     * How long the stun should last.- Given in milliseconds.
     */
